...
JDI_FILE := I:/cpu/s1013353_hw14/sopc/RamAndFlash.jdi
...
# Design Name 
# setting SOPC_NAME is RamAndFlash_sopc
SOPC_NAME := RamAndFlash_sopc
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x18050a8
SOPC_SYSID_FLAG += --sidp=0x18050a8
ELF_PATCH_FLAG  += --sidp 0x18050a8

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1465700091
SOPC_SYSID_FLAG += --timestamp=1465700091
ELF_PATCH_FLAG  += --timestamp 1465700091
